...
<form role="search" method="get" class="ab-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>"
	...
	<label class="screen-reader-text" for="<?php echo esc_attr( $ab_search_id ); ?>">
		<?php esc_html_e( 'Buscar en el sitio', 'adeptbuild' ); ?>
	</label>
	<input
		type="search"
		...
		placeholder="<?php esc_attr_e( 'Buscar…', 'adeptbuild' ); ?>">
	<button type="submit" class="ast-button ab-btn--sm"><?php esc_html_e( 'Buscar', 'adeptbuild' ); ?></button>
</form>
